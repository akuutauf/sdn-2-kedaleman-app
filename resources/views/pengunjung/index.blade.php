...
<body>
        ...
        <div class="container bg-white p-5 shadow-sm rounded">
            <div class="row">
                ...
                <div class="col-lg-6 d-lg-flex flex-lg-column align-items-stretch order-1 order-lg-2 hero-img"
                    data-aos="fade-up">
                    <img src="{{ asset('pengunjung/assets/img/school-ilustration.png') }}" class="img-fluid rounded"
                        alt="">
                </div>
            </div>
        </div>
    ...
    <!-- ======= Hero Section ======= -->
    <section id="hero" class="d-flex align-items-center">
        <div class="container position-relative section-bg shadow-sm rounded p-5" data-aos="fade-up"
            data-aos-delay="100">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 video-box align-self-baseline" data-aos="fade-right" data-aos-delay="100">
                        <img src="{{ asset('pengunjung/assets/img/about-video.jpg') }}" class="img-fluid"
                            alt="">
                        <a href="https://youtu.be/z4RwoTSOp-A" class="glightbox play-btn mb-4" data-vbtype="video"
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center"
                        data-aos="zoom-in">
                        <img src="{{ asset('pengunjung/assets/img/clients/client-1.png') }}" class="img-fluid"
                            alt="">
                    </div>
                ...
                <div class="row mt-5">
                    <div class="col-lg-4">
                        <div class="info bg-white">
                            <div class="address">
                                <i class="bi bi-geo-alt bg-transparent"></i>
                                <h4>Location:</h4>
                                <p>A108 Adam Street, New York, NY 535022</p>
                            </div>

                            <div class="email">
                                <i class="bi bi-envelope bg-transparent"></i>
                                <h4>Email:</h4>
                                <p>info@example.com</p>
                            </div>

                            <div class="phone">
                                <i class="bi bi-phone bg-transparent"></i>
                                <h4>Call:</h4>
