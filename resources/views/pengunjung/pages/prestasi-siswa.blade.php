...
@section('title')
    @foreach ($latest as $title)
        <title>{{ $title->judul_prestasi }} | SDN 2 Kedaleman</title>
    @endforeach
                    ...
                    @foreach ($latest as $item)
                            ...
                            <div class="portfolio-details-slider swiper">
                                <div class="swiper-wrapper align-items-center">
                                    <div class="swiper-slide">
                                        <img src="{{ asset('images/prestasi/' . $item->foto_prestasi) }}" class="rounded"
                                            alt="">
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 mt-3">
                            <div class="portfolio-info">
                                ...
                                <ul>
                                    <li><strong>Tanggal</strong>: <i>{{ dateConversion($item->tanggal_prestasi) }}</i>
                                    </li>
                                    <li><strong>Perlombaan</strong>: <i>{{ $item->nama_perlombaan }}</i></li>
                                    <li><strong>Siswa Berprestasi</strong>: <i>{{ $item->peraih_prestasi }}</i></li>
                                </ul>
                            </div>
                        </div>
                    @endforeach
