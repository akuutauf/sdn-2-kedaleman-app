...
@section('title')
    <title>{{ $this_pengumuman->judul_pengumuman }} | SDN 2 Kedaleman</title>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-8">
                        <div class="portfolio-description">
                            <div class="container">
                                <h2>{{ $this_pengumuman->judul_pengumuman }}</h2>
                                <p class="paragrhap-justify">
                                    {{ $this_pengumuman->isi_pengumuman }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            ...
                            <ul>
                                <li><strong>Perihal</strong>: <i>{{ $this_pengumuman->perihal_pengumuman }}</i></li>
                                <li><strong>Pembuat</strong>: <i>{{ $this_pengumuman->pembuat_pengumuman }}</i></li>
                                <li><strong>Penerima</strong>: <i>{{ $this_pengumuman->penerima_pengumuman }}</i></li>
                                <li><strong>Tanggal</strong>:
                                    <i>{{ dateConversion($this_pengumuman->tanggal_pengumuman) }}</i>
                                </li>
                                <li><strong>Lampiran</strong>: <a
                                        href=" {{ asset('dokumen/pengumuman/' . $this_pengumuman->lampiran_pengumuman) }}"
                                ...
                                <div class="item">
                                    ...
                                    <div class="card card-border-none shadow-sm bg-white">
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('pengumuman.show', $itemPengumuman->id) }}"
