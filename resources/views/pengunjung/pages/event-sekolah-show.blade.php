...
@section('title')
    <title>{{ $this_event->judul_event }} | SDN 2 Kedaleman</title>
                ...
                <div class="row">
                        ...
                        <div class="portfolio-details-slider swiper">
                            <div class="swiper-wrapper align-items-center">
                                <div class="swiper-slide">
                                    <img src="{{ asset('images/event/' . $this_event->foto_event) }}" class="rounded"
                                        alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 mt-3">
                        <div class="portfolio-description">
                            <div class="container">
                                <h2>{{ $this_event->judul_event }}</h2>
                                <p class="paragrhap-justify">
                                    {{ $this_event->desc_event }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 mt-3">
                        <div class="portfolio-info">
                            <h3>Detail Event</h3>
                            <ul>
                                <li><strong>Lokasi</strong>: <i>{{ $this_event->lokasi_event }}</i></li>
                                <li><strong>Tanggal</strong>: <i>{{ dateConversion($this_event->tanggal_event) }}</i>
                                </li>
                                <li><strong>Penyelenggara</strong>: <i>{{ $this_event->penyelenggara_event }}</i></li>
                            </ul>
                        </div>
                    </div>
                </div>
