...
<head>
    ...
    <!-- Style Carousel -->
    <link rel="stylesheet" href="{{ asset('pengunjung/assets/carousel/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('pengunjung/assets/carousel/css/style.css') }}">
    {{-- <link rel="stylesheet" href="{{ asset('pengunjung/assets/carousel/css/bootstrap.min.css') }}"> --}}
    {{-- <link rel="stylesheet" href="{{ asset('pengunjung/assets/carousel/fonts/icomoon/style.css') }}"> --}}
</head>
