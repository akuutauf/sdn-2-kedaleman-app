...
@section('title')
    ...
    <title>Update Data Arsip | Manajemen Website</title>
@endsection
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Update Data Arsip Sekolah</strong>
                                <p class="mt-2">Formulir untuk mengubah data file arsip sekolah, masukkan informasi yang
                                    ingin
                                    diubah, dan
                                    ketika ingin mengubah data maka mohon upload ulang file arsip.</p>
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control date-input"
                                                            ...
                                                            value="{{ $arsip->tanggal_upload_arsip }}" />
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="jenis_file_arsip"
                                                            ...
                                                            <option value="Arsip Guru"
                                                                {{ $arsip->jenis_file_arsip == 'Arsip Guru' ? 'selected' : '' }}>
                                                                Arsip Guru</option>
                                                            <option value="Arsip Nilai"
                                                                {{ $arsip->jenis_file_arsip == 'Arsip Nilai' ? 'selected' : '' }}>
                                                                Arsip Nilai</option>
                                                            <option value="Arsip Siswa"
                                                                {{ $arsip->jenis_file_arsip == 'Arsip Siswa' ? 'selected' : '' }}>
                                                                Arsip Siswa</option>
                                                            <option value="Arsip Prestasi"
                                                                {{ $arsip->jenis_file_arsip == 'Arsip Prestasi' ? 'selected' : '' }}>
                                                                Arsip Prestasi</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="desc_file_arsip" rows="4" name="desc_file_arsip">{{ $arsip->desc_file_arsip }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
