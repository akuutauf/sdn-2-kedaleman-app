...
@section('title')
    ...
    <title>Update Data Event | Manajemen Website</title>
@endsection
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Update Data Event Sekolah</strong>
                                <p class="mt-2">Formulir untuk mengubah data event sekolah, masukkan informasi yang ingin
                                    diubah, dan
                                    ketika ingin mengubah data maka mohon upload ulang foto event.</p>
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="penyelenggara_event"
                                                            ...
                                                            value="{{ $event->penyelenggara_event }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            ...
                                                            value="{{ $event->penanggung_jawab_event }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="status_event"
                                                            ...
                                                            <option value="Aktif"
                                                                {{ $event->status_event == 'Aktif' ? 'selected' : '' }}>
                                                                Aktif</option>
                                                            <option value="Non-aktif"
                                                                {{ $event->status_event == 'Non-aktif' ? 'selected' : '' }}>
                                                                Non-aktif</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="desc_event" rows="4" name="desc_event">{{ $event->desc_event }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
