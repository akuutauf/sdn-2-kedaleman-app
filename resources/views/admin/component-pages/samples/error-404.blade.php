...
@section('title')
    ...
    <title>Eror 404 | Manajemen Website</title>
@endsection

@section('content')
    <div class="container">
        <div class="container-fluid page-body-wrapper full-page-wrapper">
            <div class="content-wrapper text-center error-page bg-primary">
                <div class="row flex-grow pt-5 mt-5 justify-content-evenly">
